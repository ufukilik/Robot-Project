...
public class seri implements manipulator{
    ...
    public seri(int motorSayisi, int yukMiktari, String robotTipi, int yukTasimaKapasitesi, int kolUzunlugu, int tasimaHizi) {
